...
st.markdown("Check **Optimize_Qty** to buy/sell assets. Check **Optimize_Limit** to let the AI tighten/loosen the downstream Kanban buffer to choke overproduction.")
...
default_nodes = pd.DataFrame({
    ...
    "Max_WIP_Limit": [9999, 9999, 50, 50, 100, 9999, 9999], # Finite capacity limits!
